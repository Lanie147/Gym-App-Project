  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-center   gap-2">
        ...
        <h4 className="text-xl sm:text-2xl md:text-3">{title}</h4>
      </div>
...
function Generator(props) {
  ...
  return (
    ...
    >
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 px-4 border duration-200 hover:border-blue-600 py-3 rounded-lg " +
      ...
      />
      <div className="bg-slate-950 border flex flex-col border-solid border-blue-400 rounded-lg p-3">
        <button
          onClick={toggleModal}
